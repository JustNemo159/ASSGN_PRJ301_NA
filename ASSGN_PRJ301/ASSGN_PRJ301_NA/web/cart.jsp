                    ...
                    <c:otherwise>
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${carts}" var="c">
                                    ...
                                    <form action="update-quantity">
                                        ...
                                        <td>
                                            <input onchange="return validateQuantity(this)" type="number" name="quantity" value="${c.value.quantity}" min="1"/>
                        ...
                        <script>
                            function validateQuantity(element) {
                                ...
                                var minQuantity = 1; // Giá trị nhỏ nhất cho số lượng

                                if (quantity <= minQuantity) {
                                    alert("Số lượng không thể giảm thêm. Giá trị nhỏ nhất là 1.");
                                    element.value = minQuantity; // Đặt lại giá trị về giá trị nhỏ nhất
                                    return false; // Không thực hiện submit form
                                }

                                return true; // Tiếp tục thực hiện submit form
                            }
                        </script>
